...
// Function GA_DanceGrenade_Stun.GA_DanceGrenade_Stun_C.FailedToActivatePassiveAbility
// (Event, Public, BlueprintEvent)

void UGA_DanceGrenade_Stun_C::FailedToActivatePassiveAbility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_DanceGrenade_Stun_C", "FailedToActivatePassiveAbility");
