...
public:
	...
	UEAllocatedWString GetFullWName() const;
	UEAllocatedString GetName() const;
	UEAllocatedWString GetWName() const;
	...
	FProperty* GetProperty(const FName& ChildName) const;
	int32 GetOffset(const FName& ChildName) const;

	template<typename T>
	T& Get(int32 Offset) const
	{
		return *(T*)(__int64(this) + Offset);
	}
