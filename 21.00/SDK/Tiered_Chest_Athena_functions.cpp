...
void ATiered_Chest_Athena_C::DestroyAdditionalVFXComponents()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "DestroyAdditionalVFXComponents");
...
// Function Tiered_Chest_Athena.Tiered_Chest_Athena_C.AudioOnOpened
// (BlueprintCallable, BlueprintEvent)

void ATiered_Chest_Athena_C::AudioOnOpened()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Tiered_Chest_Athena_C", "AudioOnOpened");
