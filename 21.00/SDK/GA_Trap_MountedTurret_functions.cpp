...
// Function GA_Trap_MountedTurret.GA_Trap_MountedTurret_C.FailedToActivatePassiveAbility
// (Event, Public, BlueprintEvent)

void UGA_Trap_MountedTurret_C::FailedToActivatePassiveAbility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Trap_MountedTurret_C", "FailedToActivatePassiveAbility");
