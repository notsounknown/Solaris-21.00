...
void ABP_PlayerPawn_NonParticipant_C::BndEvt__ConvertComponent_K2Node_ComponentBoundEvent_1_UnconvertedEvent__DelegateSignature(class AFortPawn* UnconvertedPawn)
{
	static class UFunction* Func = nullptr;
