...
public:
	static FGameplayAbilitySpec GiveAbility(UAbilitySystemComponent*, UObject*);
	static TArray<FGameplayAbilitySpec> GiveAbilitySet(UAbilitySystemComponent*, UFortAbilitySet*);
