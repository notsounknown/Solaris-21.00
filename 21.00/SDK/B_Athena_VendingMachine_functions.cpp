...
void AB_Athena_VendingMachine_C::BlueprintOnInteract(const class AFortPawn* InteractingPawn_0, const EInteractionBeingAttempted InteractionBeingAttempted)
{
	static class UFunction* Func = nullptr;
...
void AB_Athena_VendingMachine_C::BlueprintOnBeginInteract(const class AFortPawn* InteractingPawn_0, const EInteractionBeingAttempted InteractionBeingAttempted, const ETInteractionType InteractionType)
{
	static class UFunction* Func = nullptr;
	...
	Params::B_Athena_VendingMachine_C_BlueprintOnBeginInteract Parms{};
...
class FText AB_Athena_VendingMachine_C::BlueprintGetInteractionString(const class AFortPawn* InteractingPawn_0, const EInteractionBeingAttempted InteractionBeingAttempted) const
{
	static class UFunction* Func = nullptr;
