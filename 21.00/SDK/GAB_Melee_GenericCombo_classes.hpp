...
static_assert(sizeof(UGAB_Melee_GenericCombo_C) == 0x000B58, "Wrong size on UGAB_Melee_GenericCombo_C");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, UberGraphFrame_GAB_Melee_GenericCombo_C) == 0x000B48, "Member 'UGAB_Melee_GenericCombo_C::UberGraphFrame_GAB_Melee_GenericCombo_C' has a wrong offset!");
static_assert(offsetof(UGAB_Melee_GenericCombo_C, OriginalMontagePlayRate) == 0x000B50, "Member 'UGAB_Melee_GenericCombo_C::OriginalMontagePlayRate' has a wrong offset!");
