...
static_assert(sizeof(UGAB_SurfaceChange_Vehicle_C) == 0x000C98, "Wrong size on UGAB_SurfaceChange_Vehicle_C");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, UberGraphFrame) == 0x000B10, "Member 'UGAB_SurfaceChange_Vehicle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, Debug) == 0x000B18, "Member 'UGAB_SurfaceChange_Vehicle_C::Debug' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, RemovalDelay) == 0x000B20, "Member 'UGAB_SurfaceChange_Vehicle_C::RemovalDelay' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, GE_SurfaceChange_Ice) == 0x000B48, "Member 'UGAB_SurfaceChange_Vehicle_C::GE_SurfaceChange_Ice' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, BaseVerticalBounceVelocity) == 0x000B50, "Member 'UGAB_SurfaceChange_Vehicle_C::BaseVerticalBounceVelocity' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, BaseLateralBounceVelocity) == 0x000B78, "Member 'UGAB_SurfaceChange_Vehicle_C::BaseLateralBounceVelocity' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, LavaBounceMultiplier) == 0x000BA0, "Member 'UGAB_SurfaceChange_Vehicle_C::LavaBounceMultiplier' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, BounceMultiplierStepAmount) == 0x000BA8, "Member 'UGAB_SurfaceChange_Vehicle_C::BounceMultiplierStepAmount' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, MaxBounceMultiplier) == 0x000BD0, "Member 'UGAB_SurfaceChange_Vehicle_C::MaxBounceMultiplier' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, RandomConeAngle) == 0x000BF8, "Member 'UGAB_SurfaceChange_Vehicle_C::RandomConeAngle' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, ReplicatedRandomAngle) == 0x000C20, "Member 'UGAB_SurfaceChange_Vehicle_C::ReplicatedRandomAngle' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, FacingAngleVelocityComponent) == 0x000C28, "Member 'UGAB_SurfaceChange_Vehicle_C::FacingAngleVelocityComponent' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, IceTags) == 0x000C50, "Member 'UGAB_SurfaceChange_Vehicle_C::IceTags' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, LavaTags) == 0x000C70, "Member 'UGAB_SurfaceChange_Vehicle_C::LavaTags' has a wrong offset!");
static_assert(offsetof(UGAB_SurfaceChange_Vehicle_C, LavaBounceCue) == 0x000C90, "Member 'UGAB_SurfaceChange_Vehicle_C::LavaBounceCue' has a wrong offset!");
