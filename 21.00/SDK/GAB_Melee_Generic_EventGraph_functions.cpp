...
void UGAB_Melee_Generic_EventGraph_C::GetLocationAtDistanceFromActorFacing(class AActor* Actor, float Distance, float Rotation_Pitch_, float Rotation_Yaw_, struct FVector* Location) const
{
	static class UFunction* Func = nullptr;
