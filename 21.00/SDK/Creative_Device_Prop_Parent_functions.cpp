...
void ACreative_Device_Prop_Parent_C::MigrateLegacyEnabledIndex(bool* MigratedProperties)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    bMigrateEnabledIndex                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    bMigrateActivateOnPhase                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ACreative_Device_Prop_Parent_C::MigrateLegacyDeviceParentUserOptions(bool bMigrateEnabledIndex, bool bMigrateActivateOnPhase)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Creative_Device_Prop_Parent_C", "MigrateLegacyDeviceParentUserOptions");

	Params::Creative_Device_Prop_Parent_C_MigrateLegacyDeviceParentUserOptions Parms{};

	Parms.bMigrateEnabledIndex = bMigrateEnabledIndex;
	Parms.bMigrateActivateOnPhase = bMigrateActivateOnPhase;
...
void ACreative_Device_Prop_Parent_C::MigrateLegacyActivateOnGamePhase(bool* MigratedProperties)
{
	static class UFunction* Func = nullptr;
