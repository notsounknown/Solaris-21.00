...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0CABA728;
	constexpr int32 AppendString      = 0x010A05F4;
	constexpr int32 GNames            = 0x0CCB6E80;
	constexpr int32 GWorld            = 0x0CC65A08;
	constexpr int32 GEngine           = 0x0CA062F8;
	constexpr int32 ProcessEvent      = 0x00DC8548;
...
private:
	static inline void* GObjectsAddress = reinterpret_cast<void*>(*(uint64_t*)(__readgsqword(0x60) + 0x10) + Offsets::GObjects);
...
public:
	inline FName(wchar_t* str) {
		auto FNameConstructor = reinterpret_cast<void(*)(FName*, wchar_t*, int)>(Sarah::Offsets::FNameConstructor);
		FNameConstructor(this, str, 1);
	}

	inline FName(const wchar_t* str) {
		auto FNameConstructor = reinterpret_cast<void(*)(FName*, const wchar_t*, int)>(Sarah::Offsets::FNameConstructor);
		FNameConstructor(this, str, 1);
	}
	...
	inline FName(FString str) {
		auto FNameConstructor = reinterpret_cast<void(*)(FName*, wchar_t*, int)>(Sarah::Offsets::FNameConstructor);
		FNameConstructor(this, str.GetData(), 1);
	}


	inline FName(int _Ci = 0)
		: ComparisonIndex(_Ci)
	{
	}
...
public:
	...
	TSoftObjectPtr(UEType* Obj)
	{
		...
		ObjectID.AssetPathName = Obj ? FName(Obj->GetFullWName().c_str()) : FName(0);
	}
...
public:
	...
	{
		return (InterfaceType*)GetInterfaceRef();
	}
};
