...
void ABGA_Athena_Lock_Parent_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_Athena_Lock_Parent_C", "ReceiveEndPlay");

	Params::BGA_Athena_Lock_Parent_C_ReceiveEndPlay Parms{};
