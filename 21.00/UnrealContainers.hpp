...
namespace UC
{
	...
	{
	public:
		static void* InternalRealloc(void* _a1, __int64 _a2, unsigned int _a3) {
...
#pragma warning(suppress: 4244)
	...
	*/
	...
	public:
		...
		inline void Remove(int32 Index, int32 Count = 1)
		{
			for (; Count; --Count)
			{
	...
	public:
		...
		template <typename ComparisonType>
		void Remove(const ComparisonType& Element)
		{
	...
	public:
		auto Find(const KeyElementType& Key, bool(*Equals)(const KeyElementType& LeftKey, const KeyElementType& RightKey) = [](const KeyElementType& LeftKey, const KeyElementType& RightKey) ->bool { return LeftKey == RightKey; })
		{
			for (auto It = this->begin(); It != this->end(); ++It)
			{
	...
	namespace Iterators
	{
		...
		public:
			...
			inline void DecBecauseThisSDKSucks()
			{
				--BitIterator;
			}
