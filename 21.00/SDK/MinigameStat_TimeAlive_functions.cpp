...
int32 UMinigameStat_TimeAlive_C::Accumulate(int32 A, int32 B) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MinigameStat_TimeAlive_C", "Accumulate");

	Params::MinigameStat_TimeAlive_C_Accumulate Parms{};
