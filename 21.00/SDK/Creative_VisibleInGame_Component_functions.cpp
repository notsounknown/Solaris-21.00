...
void UCreative_VisibleInGame_Component_C::ShouldUpdateActivationBasedOnVisbility(class UActorComponent* Component, bool* ShouldUpdateActivation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Creative_VisibleInGame_Component_C", "ShouldUpdateActivationBasedOnVisbility");

	Params::Creative_VisibleInGame_Component_C_ShouldUpdateActivationBasedOnVisbility Parms{};
